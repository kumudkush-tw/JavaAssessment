...
//        addPrerequisite(new Module("INTRO-WEB", "Web Development Fundamentals",
//                "Introduction to fundamentals of web development"));
       ...
       // registerCourse(new Course("xx", "testCourse", 5, moduleWebFundamentals));
    ...
    {
//        if (enrolledStudents.containsValue(student.getId())){
...
//            }
//        }
        //TO IMPLEMENT NON DUPLICATE ENROLMENT FOR A COURSE
        if ( !enrolledStudents.containsKey( courseId ) )
        {
            enrolledStudents.put( courseId, new ArrayList<>() );
        }
